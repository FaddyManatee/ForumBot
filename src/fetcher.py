...
class Fetcher(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if  message.mention_everyone and "meeting time" in text:
    ...
    async def fetcher(self):
        ...
        self.new_embeds = await self.generate_embeds(self.rss.get_new_threads())
        self.appeal_embeds = await self.generate_embeds(self.rss.get_appeal_threads())
        self.application_embeds = await self.generate_embeds(self.rss.get_application_threads())
